...
dict <- tibble::tribble(
  ...
  "diagmdy", "Date of diagnosis. The registry 'best' diagnosis date (DIAGNOSISDATEBEST), taken as the mid-point of the earliest and latest plausible diagnosis dates; it is the index date from which all waiting times and windows are measured.", "range 2015-01-02 to 2022-12-31", "NCRAS Cancer registry (DIAGNOSISDATEBEST)", "essential - the index date",
  "ydiag", "Year of diagnosis. Calendar year extracted from diagmdy, for cohort selection and year-on-year breakdowns.", "range 2015 to 2022 (median 2018)", "Derived from diagmdy", "useful - cohort selection and year breakdowns",
