...
endoscopy_anchor_combined <- readRDS(paste0(base_dir, "OG_endoscopy_anchor_combined.rds"))
emresd_anchor             <- readRDS(paste0(base_dir, "OG_emresd_anchor.rds"))
surgery_anchor            <- readRDS(paste0(base_dir, "og_surgery_anchor_2015_2022.rds"))
sact_anchor               <- readRDS(paste0(base_dir, "og_sact_anchor_2015_2022.rds"))
rt_anchor                 <- readRDS(paste0(base_dir, "rt_anchor_og.rds"))
...
# =============================================================================
saveRDS(og_cohort_spec, paste0(base_dir, "og_cohort_precwt_spec_2015_2022.rds"))
saveRDS(list(pre_cwt_spec = pre_cwt_spec, cwt_spec = cwt_spec,
        ...
        paste0(base_dir, "og_pipeline_spec.rds"))
