...
cohort <- readRDS(file.path(syn_dir, "og_cohort_precwt_SYNTH.rds")) %>%
...
# =============================================================================
write_dta(dist_matrix, file.path(prov_dir, "OG_pairwise_distance_matrix_SYNTH.dta"))
write_dta(valid_sites, file.path(prov_dir, "NHSHospitals_valid_sites_SYNTH.dta"))
