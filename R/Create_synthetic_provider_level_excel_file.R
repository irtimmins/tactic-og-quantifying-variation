...
sites <- read_dta(paste0(base_dir, "provider_level/NHSHospitals_valid_sites_SYNTH.dta")) %>%
  distinct(diag_hosp) %>%
...
out_xlsx <- paste0(base_dir, "provider_level/NHSHospitals_services_SYNTH.xlsx")
