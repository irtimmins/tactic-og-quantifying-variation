...
syn               <- readRDS(paste0(base_dir, "og_cohort_precwt_SYNTH.rds"))
...
if (file.exists(paste0(base_dir, "og_profile_for_synthetic.rds"))) {
  prof <- readRDS((paste0(base_dir, "og_profile_for_synthetic.rds")))
